...
export default async function ArHomePage() {
  ...
  // @graph on every route, including Arabic ones, with name kept in Latin script
  // ("TechParadice") so both locales resolve to the same entity. The nodes that
  // used to live here also set url to ${SITE_URL}/ar — a language section, not
  // the organisation's canonical URL.
  return (
    <>
      <PageHero
