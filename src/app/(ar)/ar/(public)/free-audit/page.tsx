...
export default function ArFreeAuditPage() {
  // Mirrors the English free-audit page: Service + zero-price Offer.
  const jsonLd = pageGraph(
    serviceNode({
      locale: 'ar',
      pagePath: '/free-audit',
      name: `تدقيق رقمي مجاني — ${BRAND.name}`,
      description:
        'اطلب تدقيقًا مجانيًا لموقعك وأداء SEO وحضورك الرقمي، واحصل على توصيات واضحة ومرتبة حسب الأولوية.',
      serviceType: 'Website and SEO audit',
      offers: { price: '0', priceCurrency: 'USD', name: 'تدقيق رقمي مجاني' },
    }),
    breadcrumbNode('ar', '/free-audit', [['تدقيق مجاني', '/free-audit']]),
  )
