  ...
  return (
    <>
      <IndustrySchema
        ...
        name="التسويق الرقمي لورش السيارات"
        description="SEO محلي، وحملات بحث، ودعم للسمعة، ومواقع، ومسارات للحجز تناسب ورش السيارات ومراكز الخدمة."
        audience="ورش السيارات"
        crumb="ورش السيارات"
      />
      <PageHero
