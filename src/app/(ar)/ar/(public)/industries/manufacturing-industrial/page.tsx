  ...
  return (
    <>
      <IndustrySchema
        ...
        name="الحلول الرقمية لشركات التصنيع والصناعة"
        description="كتالوجات منتجات، وبوابات للموزعين، ومواقع B2B متعددة اللغات، ومسارات للاستفسارات، وSEO، ومساعدات AI للمصنّعين والشركات الصناعية."
        audience="التصنيع والصناعة"
        crumb="التصنيع والصناعة"
      />
      <PageHero
