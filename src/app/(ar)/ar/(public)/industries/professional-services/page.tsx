  ...
  return (
    <>
      <IndustrySchema
        ...
        name="التسويق الرقمي لشركات الخدمات المهنية"
        description="مواقع موثوقة، وSEO، ومحتوى متخصص، وحملات، ومسارات للاستفسارات تناسب الاستشاريين والمحاسبين والمستشارين وشركات الخدمات المهنية."
        audience="الخدمات المهنية"
        crumb="الخدمات المهنية"
      />
      <PageHero
