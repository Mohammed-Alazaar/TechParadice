...
export default function FreeAuditPage() {
  // The conversion page: a Service with a zero-price Offer, so the "free" part
  // is machine-readable rather than only stated in the copy.
  const jsonLd = pageGraph(
    serviceNode({
      ...
      description:
        'A free review of your website, SEO, and digital presence, returned as clear, prioritised recommendations.',
      serviceType: 'Website and SEO audit',
      offers: { price: '0', priceCurrency: 'USD', name: 'Free Website & SEO Audit' },
    }),
    breadcrumbNode('en', '/free-audit', [['Free Audit', '/free-audit']]),
  )
