  ...
  return (
    <>
      <IndustrySchema
        locale="en"
        path="/industries/b2b-businesses"
        name="Digital Strategy for B2B Businesses"
        description="B2B websites, lead-generation journeys, account-focused campaigns, responsible automation, SEO, and pipeline analytics."
        audience="B2B Businesses"
        crumb="B2B Businesses"
      />
      <PageHero
