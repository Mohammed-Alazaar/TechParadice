  ...
  return (
    <>
      <IndustrySchema
        locale="en"
        path="/industries/auto-repair"
        name="Digital Marketing for Auto Repair Shops"
        description="Local SEO, search campaigns, reputation support, websites, and booking journeys for garages and automotive service centres in the GCC."
        audience="Auto Repair"
        crumb="Auto Repair"
      />
      <PageHero
        eyebrow="Auto Repair"
