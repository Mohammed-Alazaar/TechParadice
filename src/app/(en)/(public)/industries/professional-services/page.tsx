  ...
  return (
    <>
      <IndustrySchema
        locale="en"
        path="/industries/professional-services"
        name="Digital Strategy for Professional Services"
        description="Credible websites, SEO, expert content, campaigns, and enquiry journeys for consultancies, accountants, advisers, and professional services firms."
