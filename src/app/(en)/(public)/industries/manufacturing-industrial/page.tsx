  ...
  return (
    <>
      <IndustrySchema
        locale="en"
        path="/industries/manufacturing-industrial"
        name="Digital Platforms for Manufacturing & Industry"
        description="Product catalogues, dealer portals, multilingual B2B websites, enquiry workflows, SEO, and AI assistants for manufacturers and industrial companies."
        audience="Manufacturing & Industrial"
        crumb="Manufacturing & Industrial"
      />
      <PageHero
