  ...
  return (
    <>
      ...
      <Section tone="void" className="pt-0">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-6 heading-h2 text-white">What’s included</h2>
            <p className="mt-3 max-w-md text-white/70">
              A scoped, transparent set of deliverables — adjusted to your
              goals during kickoff.
            </p>
          </div>
          <ul className="space-y-3">
            {service.deliverables.map((d) => (
              <li
                key={d}
                className="flex gap-3 rounded-lg border border-border-dark bg-surface p-5"
              >
      ...
      <Section tone="surface">
        <SectionHeading
          eyebrow="Process"
          title={`How a ${service.name.toLowerCase()} engagement runs`}
        />
        <ol className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {service.process.map((p, i) => (
            ...
            >
              <span className="font-display text-[28px] font-extrabold text-teal">
                0{i + 1}
              </span>
              <h3 className="mt-3 font-display text-h4 font-semibold text-white">
                {p.step}
              </h3>
                ...
                <li key={r.slug}>
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-2 text-[14px] text-white/60">{r.short}</p>
                    </div>
