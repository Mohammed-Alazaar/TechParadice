      ...
      <div className="container-content py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-4 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 max-w-xs text-[14px] text-white/60">
              {BRAND.taglineShort}
            </p>
              ...
              {services.map((s) => (
                <li key={s.slug}>
                  <Link
                    ...
                    className="text-[14px] text-white/70 transition-colors hover:text-teal"
                  >
                    {s.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <Link href="/about" className="text-[14px] text-white/70 hover:text-teal">
                  About
                </Link>
              </li>
              <li>
                <Link href="/process" className="text-[14px] text-white/70 hover:text-teal">
                  Process
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className="text-[14px] text-white/70 hover:text-teal">
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-[14px] text-white/70 hover:text-teal">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-[14px] text-white/70 hover:text-teal">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[14px] text-white/70 hover:text-teal">
                  Contact
                </Link>
              </li>
            </ul>
