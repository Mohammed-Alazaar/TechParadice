...
const copy = {
  ...
  ar: {
    ...
    services: [
      ...
      { slug: 'mobile-apps', name: 'تطبيقات الجوال' },
      { slug: 'ui-ux-design', name: 'تصميم UI/UX' },
      { slug: 'seo-content', name: 'SEO والمحتوى' },
      { slug: 'social-media', name: 'السوشيال ميديا' },
      { slug: 'paid-ads', name: 'الإعلانات المدفوعة' },
      { slug: 'ai-assistants', name: 'مساعدو الذكاء الاصطناعي' },
    ],
  },
}
