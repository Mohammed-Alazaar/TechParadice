...
const copy = {
  en: {
    ...
    budget: 'Budget',
    timeline: 'Timeline',
    servicesLabel: 'Services you may need',
    message: 'Tell us about your project', messagePh: 'Share your goals, current challenges, and what success would look like.',
    send: 'Request a quote', sending: 'Sending…',
    successTitle: 'Thank you — your request is with us.',
    successBody: 'We review every request personally and aim to respond within one business day.',
    projectTypes: [
      { value: '', label: 'Choose…' },
    ...
    services: [
      ...
      { slug: 'voice-ai-receptionist', name: 'Voice AI Receptionist' },
      { slug: 'customer-support-ai', name: 'Customer Support AI' },
      { slug: 'sales-lead-qualification-ai', name: 'Sales & Lead Qualification AI' },
      { slug: 'business-analytics-ai', name: 'Business Analytics AI' },
      { slug: 'internal-knowledge-ai', name: 'Internal Knowledge AI' },
      { slug: 'meeting-executive-ai', name: 'Meeting & Executive AI' },
    ],
  },
  ar: {
    ...
    message: 'أخبرنا عن مشروعك', messagePh: 'شاركنا أهدافك وتحدياتك الحالية وكيف تتصور النجاح.',
    send: 'اطلب عرض سعر', sending: 'جارٍ الإرسال…',
    successTitle: 'شكراً لك — وصلنا طلبك.',
    successBody: 'نراجع كل طلب شخصياً، ونسعى إلى الرد خلال يوم عمل واحد.',
    projectTypes: [
      { value: '', label: 'اختر…' },
      { value: 'new', label: 'مشروع جديد' },
      { value: 'redesign', label: 'إعادة تصميم أو إعادة بناء' },
      { value: 'ongoing', label: 'شراكة مستمرة' },
    ],
    budgets: [
      { value: '', label: 'اختر…' },
      { value: '0-500', label: '$0 – $500' },
    ...
    services: [
      { slug: 'web-development', name: 'تطوير المواقع' },
      { slug: 'mobile-app-development', name: 'تطوير تطبيقات الجوال' },
      { slug: 'ui-ux-design', name: 'تصميم UI/UX مخصص' },
      { slug: 'seo', name: 'SEO' },
      { slug: 'content-creation', name: 'إنتاج المحتوى' },
      { slug: 'paid-advertising', name: 'الإعلانات المدفوعة' },
      { slug: 'voice-ai-receptionist', name: 'مساعد الاستقبال الذكي الصوتي' },
      { slug: 'customer-support-ai', name: 'مساعد خدمة العملاء الذكي' },
      { slug: 'sales-lead-qualification-ai', name: 'مساعد المبيعات وتأهيل العملاء' },
      { slug: 'business-analytics-ai', name: 'مساعد تحليل الأعمال الذكي' },
      { slug: 'internal-knowledge-ai', name: 'مساعد المعرفة الداخلية' },
      { slug: 'meeting-executive-ai', name: 'مساعد الاجتماعات والمدير التنفيذي' },
    ],
  },
}
